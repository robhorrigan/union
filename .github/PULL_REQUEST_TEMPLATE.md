...
- [ ] Does this introduce a new pattern/package?

## Checklist:
<!--- Go over all the following points, and put an `x` in all the boxes that apply. -->
<!--- If you're unsure about any of these, don't hesitate to ask. We're here to help! -->
- [ ] I have read the [**CONTRIBUTING**](https://github.com/xogroup/union/blob/master/.github/CONTRIBUTING.md) document.
- [ ] I have updated the documentation as needed.
- [ ] I have added tests to cover my changes.

## Reviewer Checklist

- [ ] Is change documented in a release draft? (Only if there are plans to merge PR)
